$(function () {
  ...
  var areaData = {
    labels: ["الصف الاول الاعدادى","الصف الثانى الاعدادى","الصف الثالث الاعدادى","الصف الاول الثانوى","الصف الثانى الثانوى","الصف الثالث الثانوى","الاحصاء"],
    datasets: [{
      label: 'عدد الطلاب',
      data: [num_1,num_2,num_3,num_4,num_5,num_6,num_13],
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(54, 162, 235, 0.2)',
        'rgba(255, 206, 86, 0.2)',
