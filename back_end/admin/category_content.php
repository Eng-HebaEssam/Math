                    ...
                    <div class="content-wrapper ">
                        ...
                        <?php 
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
                                if (isset($_POST['disabled_all'])) {
                                    $stmt = $con->prepare("UPDATE members SET regstatus = 0 Where groupid =?");
                                    $stmt->execute(array($row['category_id']));
                                    if ($stmt) {
                        ...
                        <div class="row ">
                            <div class="col-lg-12 grid-margin ">
                                <div class="card ">
                                    <div class="card-body ">
                                        <h4> الطلبة بالقسم</h4>
                                        <button style="color:darkblue;font-size:20px;float:left; " type="button " class="btn btn-outline-info btn-sm m-3" data-toggle="modal" data-target="#disabled_all">الغاء تفعيل حساب الجميع</button>    
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="category_content.php?category_id=<?php echo $row['category_id']; ?>" method="POST">
