                    ...
                    <div class="content-wrapper ">
                        <div class="page-header ">
                            ...
                            <div class="">
                                ...
                                <button style="color:darkblue;font-size:15px " type="button " class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#diactive_all">الغاء تفعيل الدروس</button>
                             <button style="color:darkblue;font-size:15px " type="button " class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#active_all">تفعيل الدروس</button>
                            </div>
                        </div>
                        <?php 
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                  if (isset($_POST['diactive_all'])) {
                                        $stmt = $con->prepare("UPDATE  lessons SET Approve = 0 WHERE cat_id= ?");
                                        $stmt->execute(array($category_id));
                                        $stmt->execute();
                                        if ($stmt) {
                                            echo '<div class="alert alert-success text-center alert-dismissible fade show" role="alert" id="alert-message">
                                                    تم  الغاء تفعيل الدروس بنجاح
                                ...
                                if (isset($_POST['active_all'])) {
                                        $stmt = $con->prepare("UPDATE  lessons SET Approve = 1 WHERE cat_id= ?");
                                        $stmt->execute(array($category_id));
                                        $stmt->execute();
                                        if ($stmt) {
                                            echo '<div class="alert alert-success text-center alert-dismissible fade show" role="alert" id="alert-message">
                                                    تم  تفعيل الدروس بنجاح
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>';
                        ...
                        <div class="modal fade" id="remove" tabindex="-1" aria-labelledby="removeLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="lesson_of_category.php?category_id=<?php echo $category_id ; ?>" method="POST">
                        ...
                        <div class="modal fade" id="active_all" tabindex="-1" aria-labelledby="removeLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary">
                                        <h2 class="text-light">تفعيل الدروس </h2>
                                    </div>
                                    <form action="lesson_of_category.php?category_id=<?php echo $category_id ; ?>" method="POST">
                                        <div class="modal-body">
                                            <h3 class="text-center">هل تريد تفعيل تلك الدروس</h3>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary" name="active_all">تفعيل</button>
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
                                        </div>
                                    </form>
                                </div>
                         ...
                         <div class="modal fade" id="diactive_all" tabindex="-1" aria-labelledby="removeLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary">
                                        <h2 class="text-light">الغاء تفعيل الدروس </h2>
                                    </div>
                                    <form action="lesson_of_category.php?category_id=<?php echo $category_id ; ?>" method="POST">
                                        <div class="modal-body">
                                            <h3 class="text-center">هل تريد الغاء تفعيل تلك الدروس</h3>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary" name="diactive_all">الغاء التفعيل </button>
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="float-right" action="lesson_of_category.php?category_id=<?php echo $category_id ; ?>" method="POST">
                        ...
                        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="float-right" action="lesson_of_category.php?category_id=<?php echo $category_id ; ?>" method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">
