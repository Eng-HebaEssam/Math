                    ...
                    if (isset($_POST['add'])) {
                        ...
                        if (empty($formErrors)) {
                                ...
                                $stmt = $con->prepare("INSERT INTO 
                                    category(category_name, category_description, parent, ordering, image, term)
                                VALUES(:zname, :zdesc, :zparent, :zorder, :zimage, :term)");
                                $stmt->execute(array(
                                    'zname' 	=> $name,
                                    'zdesc' 	=> $description,
                                    'zparent' 	=> $parent,
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php 
                                                    if($row['parent']==0){
                                                        ...
                                                        if ($row['term']==1) {
                                                            echo '<label class="badge badge-success">ترم اول</label>';
                                                        } elseif ($row['term']==2) {
                                                            echo '<label class="badge badge-primary">ترم تانى</label>';
                                                        }
                                                    }
                                                ?></td>
                                                <td>
                                                    <?php 
                                                        if($row['parent']!=0){
                                                            echo '<button type="button " class="btn btn-gradient-light btn-sm lesson_edit"><a href="lesson_of_category.php?category_id='.$row['category_id'].'" style="text-decoration: none;">الدروس</a></button>';
                                                        }
                                                    ?>
                            ...
                            <div class="modal-content">
                                ...
                                <form class="float-right" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group ">
                                            <h4>الترم</h4>
                                            <select name="term" class="form-control inputName" required>
