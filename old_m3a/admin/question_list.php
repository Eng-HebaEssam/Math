...
<?php
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				echo "<div class='container'>";
                    ...
                    $ques  = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
                    $ans1  = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
                    $ans2  = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
                    $ans3  = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
                    $ans4  = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
                    //right answer
