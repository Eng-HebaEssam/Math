        ...
        <div class="profile sub_cat">
            <div class="row">
                        ...
                        <div class="leftcol">
                            ...
                            <div class="contenent">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 top_main">
                                        <i class="fa fa-tasks"></i>
                                        <span class="text">: اسم القسم</span>
                                        <span class="text maincat"><?php echo $all['category_name']; ?></span>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row text-center">
                                        ...
                                        <h2>جزء الامتحانات</h2>
                                            ...
                                            <div class="lessonlist text-right">
                                                <?php 
                                                $allItem = getAllFrom("*", "exams", "where categ_id = {$catid}", "AND link = ''", "exam_id");
                ...
                <div class="col-md-3 text-right rightcol">
                    <img src="layouts/images/mainlogore.png" alt="" class="firstimg">
                    <div class="maincont">
