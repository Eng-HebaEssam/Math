...
<div class="bread">
            <div class="row">
                <div class="col-md-6 order-md-2 text-right">
                    <h2>الأستاذ/ محمد عبد العزيز عبد العال</h2>
                </div>
    ...
    <div class="header text-center">
        <div class="row">
         <div class="head">
            <h1>أنضم الينا</h1>
            <p>وكن من  المتفوقين في مادة الرياضيات</p>
             <button class="btn">أشترك الان</button>
             <button class="btn2">تسجيل الدخول</button>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="info col-md-6"> 
            <img class="img-thumbnail" src="BuzzFeed.gif" alt="" />
          </div>
          <div class="info col-md-6 text-right">
              <h2><span class="bar">لماذا</span> التعلم عن طريق الانترنت</h2>
            <p>لقد أصبح الانترنت في السنوات الاخيرة عاملا مؤثرا فى حياتنا اليومية وقد أنتشر بين الناس في عدة مجالات من التواصل الاجتماعى مرورا بنقل المعلومات وفي مجالات اخرى مثل التجارة الالكترونية والدراسة عن طريق الانترنت </p>
            <p>  كما ذكرت لجنة فلوريدا للمعاير التربوية انة عبارة عن خدمة توصيل التعلم عن طريق الشبكة العالمية. وقد اصبحت الدراسة متوفرة للجميع تقريبا في جميع انحاء العالم في وقتنا الحالى</p>
            <p class="hide"> وللتعلم عن طريق النت مميزات كثيره اكثر من التعليم التقليدي منها سهولة التفاعل بين الطالب والمعلم وسرعة الحصول على المعلومة كما ان التعليم عن بعد اقل تكلفة اضافة الي سهوله الاطلاع على المقررات الداسية والتعديل عليها بسهوله وبدون تكلفة </p>
            <p class="hide"> ولمواكبة العصر تم انشاء تلك المنصة لتكون مركز ليس فقط للتعلم عن طريق الفيديوهات الموجودة او اوراق الشرح او التدريبات المتنوعة بعد كل جزئية ولكن ايضا مركز للتفاعل بين الطلبة والمعلم لمشاركة المعلومات بطريقة سهلة وواضحة</p>
            <span class="click text-left">اظهار المزيد</span>
            <span class="second text-left"></span>  
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Start contact us -->
        ...
        <div class="contact">
            <div class="start">
              ...
              <p>التسجيل متاح مجانا لفترة محددة حتى 9/1</p>
              <input id="tab-1" type="radio" name="tab" class="signs">
                <label for="tab-1" class="tab">انشاء حساب</label>
                <label for="tab-1" class="tab hidden">تسجيل الدخول </label>
            </div>    
            <!-- Start Login Form -->
        ...
        <form class="login-up" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            <div class="row log">
                <div class="form sign-in">
                  ...
                  <input type="submit" class="btn" name="login-up" value="تسجيل الدخول">
                  <div class="foot-lnk">
        ...
        <form class="signup" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            <div class="login text-center">    
                 <div class="form sign-in">   
                  ...
                  <div class="row">     
                    <input type="submit" class="btn confirm" name="signup" value="انشاء حساب الان">
                  </div>
                 </div>
                </div>
                <div class="foot-lnk">
       ...
       <div class="our-team text-center">
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide style"><iframe width="560" height="315" src="https://www.youtube.com/embed/bq26OyPprF0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><p class="para">اعلان المنصة</p></div>
    ...
    <!-- start footer -->
        <div class="footer text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-4 order-3 order-md-2 order-lg-3" >
                    ...
                    <div class="col-md-6 col-lg-4 about order-2 order-lg-2" >
                        <h2>ما تقدمة المنصة</h2>
                        <div class="row">
                            <div class="col-7">فيديوهات شرح مبسطة لكل الدروس</div>
                            <div class="col-5">
                                <img src="layouts/images/f1.jpg" alt="" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-7">فيديوهات لحل المسائل ومسائل القدرات العلية للتفكير </div>
                            <div class="col-5">
                                <img src="layouts/images/f2.jpg" alt="" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-7">ملف pdf به ورق الشرح لكل فيديو يمكن تحميلة وطباعته</div>
                            <div class="col-5">
                                <img src="layouts/images/3.png" alt="" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-7">اختبارات تفاعلية من بنك الاسئله الخاص بنا</div>
                            <div class="col-5">
                                <img src="layouts/images/4.png" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 order-1 order-md-1 order-lg-1" >
