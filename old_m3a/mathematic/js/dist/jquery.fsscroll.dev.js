...
(function ($) {
  ...
  FsScroll.prototype = {
     ...
     * 获取每次滑动的距离
     */
    _getScrollLength: function _getScrollLength() {
    ...
    _initPagination: function _initPagination() {
      ...
      for (var i = 0; i < this.pagesCount; i++) {
        pageHtml += '<li><i class="fa fa-snowflake-o"></i></li>';
      }
    ...
    /** 滑动到当前页面 */
    _scrollPage: function _scrollPage(init) {
      var self = this,
    ...
    /** 滑动开始处理 */
    _beforeScroll: function _beforeScroll() {
      var self = this;
