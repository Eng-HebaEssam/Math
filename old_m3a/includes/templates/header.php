...
<html>
	<head>
        ...
        <link rel="stylesheet" href="<?php echo $css ?>mai.css" />
        <link rel="stylesheet" href="<?php echo $css ?>fro.css" />
        <link rel="stylesheet" href="<?php echo $css ?>countdown-lights.css" />
        <link rel="stylesheet" href="<?php echo $sun ?>" />
